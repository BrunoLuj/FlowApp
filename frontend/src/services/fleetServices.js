...
export const createFleetRecord=(vehicleId,data)=>{
  const form=new FormData();
  Object.entries(data).forEach(([key,value])=>{if(value!==""&&value!=null)form.append(key,value);});
  return api.post(`/fleet/vehicles/${vehicleId}/records`,form);
};
