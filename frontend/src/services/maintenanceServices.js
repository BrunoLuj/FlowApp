...
export const getMaintenanceOverview = () => api.get("/maintenance/overview");
...
export const recordAssetMeter = (assetId, reading) =>
  api.post(`/maintenance/assets/${assetId}/readings`, reading);
