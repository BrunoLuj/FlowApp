...
import { deleteUser, getUsers } from '../services/usersServices.js';
        ...
        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              ...
              <th className="py-3 px-4 border-b text-left">Currency</th>
          ...
          <tbody>
            {filteredUsers.map((user) => {
              ...
              const { text, class: statusClass1 } = getStatusText(user.status);
              return (
                <tr 
                  key={user.id} 
                ...
                >
                  ...
                  <td className="py-3 px-4 border-b">{user.roles_id}</td>
